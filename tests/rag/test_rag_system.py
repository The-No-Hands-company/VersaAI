...
from versaai.rag.retriever import AdaptiveRetriever, RetrieverConfig, RetrievalStrategy
...
class TestVectorStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.embedding_model = EmbeddingModel(EmbeddingConfig())
    ...
    def test_search(self):
        ...
        # Most relevant result should mention Python
        self.assertIn("Python", results[0]["document"])
...
class TestPlanner(unittest.TestCase):
    ...
    def test_execution_plan(self):
        ...
        first_stage = plan.execution_plan[0]
        for step_id in first_stage:
...
class TestRetriever(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.retriever = AdaptiveRetriever(
            self.vector_store,
            self.embedding_model,
            RetrieverConfig(strategy=RetrievalStrategy.DENSE)
        )
    ...
    def test_dense_retrieval(self):
        ...
        self.assertIn("learning", result.documents[0]["document"].lower())
